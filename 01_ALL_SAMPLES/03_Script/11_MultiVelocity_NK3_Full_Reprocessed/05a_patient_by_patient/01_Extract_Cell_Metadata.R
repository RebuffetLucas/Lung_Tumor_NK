...
if (DO_EXTRACT_NEIGBORS==TRUE){
  ...
  Object_To_Convert = FindMultiModalNeighbors(Object_To_Convert, reduction.list = c("integrated.cca" , "integrated_lsi"), dims.list = list(1:DIM_PCA, 2:DIM_LSI))
