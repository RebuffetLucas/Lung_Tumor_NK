...
ANALYSIS_04a_fullpy_STEP_NAME = "08_SCENICplus_Analysis_NK3/04a_fullpy_Step1_py_pycisTopic_Prepro_ATACseq"

ANALYSIS_STEP_NAME = "08_SCENICplus_Analysis_NK3/04b_Step2_Anndata_Prepro_scRNAseq"
...
LITERAL_TITLE = "scanpy_Preprocessing_scRNAseq"
...
PATH_TO_CELLDATA_CSV = os.path.join( PATH_EXPERIMENT_OUTPUT, ANALYSIS_04a0_STEP_NAME, "cell_data.csv") #DNAJB1 cluster has already been removed
