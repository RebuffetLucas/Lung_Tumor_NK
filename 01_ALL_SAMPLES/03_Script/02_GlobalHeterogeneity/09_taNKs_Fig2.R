...
# -- DimPlot - taNKs, non taNKs -- Fig. S4E
...
write.csv(DEGs_taNKs, "path/to/DEGs_taNKs.csv")
...
saveRDS(sigs, "path/to/sig.RDS")

#DEGs_taNKs
#order
DEGs_taNKs <- MarkerH[order(MarkerH$avg_log2FC, decreasing = T),]
...
# Plot
pdf("path/to/GSEA_sigs.pdf", height = 4, width = 7)
...
#saveResults
write.csv(df_all, "path/to/GSEA_dataframe.csv")


# -- Volcano - DEGs - NK3_ENTPD1 vs. NK3_CAMK4 -- Fig. S4H
...
# -- Signature Enrichment - adaptive NKs in NK3_ENTPD1 vs. NK3_CAMK4 -- Fig. S4I
