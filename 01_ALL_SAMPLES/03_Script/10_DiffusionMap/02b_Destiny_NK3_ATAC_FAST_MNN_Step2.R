...
#Save them
ggsave(
  file.path(PATH_ANALYSIS_OUTPUT, "Figures", "GeneActivity", paste0("Diffusion_map_DC1_DC2",Choose_feature_gene_activty_method,".pdf")),
  plot = p,
  device = NULL,
  path = NULL,
  scale = 1,
...
#Save them
ggsave(
  file.path(PATH_ANALYSIS_OUTPUT, "Figures", "GeneActivity", paste0("Diffusion_map_DC2_DC3",Choose_feature_gene_activty_method,".pdf")),
  plot = p,
  device = NULL,
  path = NULL,
  scale = 1,
...
#Fig4e
ggsave(
  file.path(PATH_ANALYSIS_OUTPUT, "Figures", "GeneActivity", paste0("Pseudotime_Plot",Choose_feature_gene_activty_method,".pdf")),
  plot = p3,
  device = NULL,
  path = NULL,
  scale = 1,
...
saveRDS(df2, file.path(PATH_ANALYSIS_OUTPUT,  "Object_GeneActivity_After_RUNFast_MNN" ,paste0("dataframe_DC_Pseudotime_",Choose_feature_gene_activty_method,".rds")))

#write as csv for python reading
df2 = readRDS( file.path(PATH_ANALYSIS_OUTPUT,  "Object_GeneActivity_After_RUNFast_MNN" ,paste0("dataframe_DC_Pseudotime_",Choose_feature_gene_activty_method,".rds")))
df2$cellname = rownames(df2)
write_csv(df2 , file.path(PATH_ANALYSIS_OUTPUT,  "Object_GeneActivity_After_RUNFast_MNN" ,paste0("dataframe_DC_Pseudotime_",Choose_feature_gene_activty_method,".csv")))
